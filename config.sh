...
# ****************************************************************************************
carelink_timestamp='dd/MM/yyyyTHH:mm:ss' # Time and date format from CareLink - locality specific
carelink_customerID='' # Customer ID from CareLink - user-specific
carelink_timestamp='MM/YY/YYTHH:mm:ss' # Please select one of these by removing the # from the beginning of just ONE option
# 'yyyy-MM-ddTHH:mm:ss' # Regional variant (copy in above if known)
# 'dd-MM-yyyyTHH:mm:ss' # Regional variant (copy in above if known)
